<?php
/**
 * Editor template for WSBB header layouts.
 * Renders layout content in <header>, page content as placeholder below.
 *
 * @since 1.0
 */
?><!DOCTYPE html>
...
<header class="fl-builder-bar" style="display:block;">
...
<div class="wsbb-editor-placeholder" style="padding:48px 24px;text-align:center;min-height:320px;display:flex;align-items:center;justify-content:center;flex-direction:column;color:#62625b;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif">
	...
	<div style="font-size:14px"><?php esc_html_e( 'This area will render your theme content below the header.', 'wsbb' ); ?></div>
</div>
