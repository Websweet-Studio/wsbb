...
<?php
// Text shadow
if (! empty($settings->text_shadow_color)) :
	$shadow_blur = isset($settings->text_shadow_blur) ? intval($settings->text_shadow_blur) : 2;
?>
	text-shadow: 0 <?php echo $shadow_blur; ?>px <?php echo $shadow_blur * 2; ?>px <?php echo FLBuilderColor::hex_or_rgb($settings->text_shadow_color); ?>;
<?php endif; ?>
}
...
.fl-node-<?php echo $id; ?> {
<?php if (! empty($settings->text_color)) : ?>
	--wsbb-text: <?php echo FLBuilderColor::hex_or_rgb($settings->text_color); ?>;
<?php endif; ?>
<?php if (! empty($settings->background_color)) : ?>
	--wsbb-bg: <?php echo FLBuilderColor::hex_or_rgb($settings->background_color); ?>;
<?php endif; ?>
<?php if (! empty($settings->border_radius)) : ?>
	--wsbb-radius: <?php echo esc_attr($settings->border_radius); ?>px;
<?php endif; ?>
}
