...
<?php if (! empty($settings->arrow_color)) : ?>
    .fl-node-<?php echo $id; ?> .wsbb-ic-arrow {
    color: <?php echo FLBuilderColor::hex_or_rgb($settings->arrow_color); ?>;
    }
<?php endif; ?>
<?php if (! empty($settings->arrow_bg_color)) : ?>
    .fl-node-<?php echo $id; ?> .wsbb-ic-arrow {
    background: <?php echo FLBuilderColor::hex_or_rgb($settings->arrow_bg_color); ?>;
    }
<?php endif; ?>

/* ── Dot colors ────────────────────────────────────────── */
<?php if (! empty($settings->dot_color)) : ?>
    .fl-node-<?php echo $id; ?> .wsbb-ic-dot {
    background: <?php echo FLBuilderColor::hex_or_rgb($settings->dot_color); ?>;
    }
<?php endif; ?>
<?php if (! empty($settings->dot_active_color)) : ?>
    .fl-node-<?php echo $id; ?> .wsbb-ic-dot.wsbb-ic-dot--active {
    background: <?php echo FLBuilderColor::hex_or_rgb($settings->dot_active_color); ?>;
    }
<?php endif; ?>